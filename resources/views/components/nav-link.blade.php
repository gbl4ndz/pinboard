...
$classes = ($active ?? false)
    ? 'inline-flex items-center px-1 pt-1 border-b-2 border-green-600 text-sm font-medium leading-5 text-stone-900 focus:outline-none transition duration-150 ease-in-out'
